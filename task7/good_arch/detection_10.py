...
class FacesPointsDetector(torch.nn.Module):
    # set dropout to 0.1
    # 
    # оставил 2 линейных слоя в хвосте
    # уменьшил колво параметров в линейном слое
    # leaky relu 
    ...
    def __init__(self):
        ...
        self.layers = nn.Sequential(
            DetectorBlock(3, 64, 7, True, self.do),
            DetectorBlock(64, 256, 5, True, self.do),
            DetectorBlock(256, 512, 3, True, self.do),
