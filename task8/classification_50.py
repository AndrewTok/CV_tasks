...
class MobileNetClassifier(nn.Module):
    ...
    def __init__(self, num_classes: int,  init_weights, unfreeze: int = 2):
        # super().___init___()
        super().__init__()
        ...
        self.net.classifier[-1].out_fetures = 50 
        # = nn.Sequential(
...
class BirdsClassifierTrainingModule(BaseBirdsClassifierTrainingModule):
    ...
    def configure_optimizers(self):
        ...
        grouped_parameters = [
            {"params": [p for _, p in params[:3]], "lr": self.lr / 10},
...
default_transform = A.Compose(
    [
        ...
        # A.Normalize(),
        A.ShiftScaleRotate(shift_limit=0.05, scale_limit=0.05, rotate_limit=70, p=0.2),
